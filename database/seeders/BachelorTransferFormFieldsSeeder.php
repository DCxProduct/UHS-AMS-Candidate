...
class BachelorTransferFormFieldsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $fields = [
            ...
            ['Last name', 'Last Name', 'នាមត្រកូល', 'text_input', true],
            ['First name', 'First Name', 'នាមខ្លួន', 'text_input', true],
            ['Family_Name', 'Family Name', 'គោត្តនាមអក្សរឡាតាំង', 'text_input', false],
            ['Given_name', 'Given Name', 'នាមខ្លួនអក្សរឡាតាំង', 'text_input', false],
            ['date_birth', 'Date of Birth', 'ថ្ងៃខែឆ្នាំកំណើត', 'date_picker', true],
            ['gender', 'Gender', 'ភេទ', 'select', true],
            ['From university', 'From University', 'មកពីសកលវិទ្យាល័យ', 'text_input', true],
            ...
            ['full_name', 'Full Name Khmer', 'នាមត្រកូល និងនាមខ្លួន', 'text_input', false],
            ...
            ['Number of children', 'Number of Children', 'ចំនួនកូន', 'number_input', false],
            ...
            ['Husband_or_wife_date_of_birth', 'Husband or Wife Date of Birth', 'ថ្ងៃខែឆ្នាំកំណើតប្ដី ឬ ប្រពន្ធ', 'date_picker', false],
            ['Nationality_of_husband_or_wife', 'Nationality of Husband or Wife', 'សញ្ជាតិរបស់ស្វាមី ឬភរិយា', 'text_input', false],
            ['Husband_or_wife_nationality', 'Husband or Wife Nationality', 'ជនជាតិប្ដី ឬ ប្រពន្ធ', 'text_input', false],
        ];
