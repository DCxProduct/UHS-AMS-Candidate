<x-filament-panels::page>
    ...
    >
        <div class="sync-card">
            ...
            <h2 class="sync-title">{{ __('sync.title') }}</h2>
            ...
            const startSync = async () => {
                ...
                try {
                    ...
                    if (response.ok && result.success) {
                        showMessage(
                            'success',
                            window.syncLang.successTitle,
                            result.message || window.syncLang.successMessage
                        );
                        return;
                    }
                    ...
                    showMessage(
                        ...
                        result.message || window.syncLang.errorMessage
                    );
                } catch (error) {
                    showMessage(
                        'error',
