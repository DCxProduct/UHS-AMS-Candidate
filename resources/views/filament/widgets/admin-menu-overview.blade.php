    ...
    <section class="uhs-admin-overview">
        <div class="uhs-admin-overview__hero">
            <div class="uhs-admin-overview__hero-main">
                <span class="uhs-admin-overview__eyebrow">{{ __('dashboard.quick_access') }}</span>
                <h2 class="uhs-admin-overview__title">{{ __('dashboard.management_overview') }}</h2>
                <p class="uhs-admin-overview__description">
                    {{ __('dashboard.management_overview_description') }}
                </p>
            </div>

            <div class="uhs-admin-overview__highlights">
