...
return [
    ...
    'role_menu' => [
        ...
        'key' => 'ពាក្យគន្លឹះ',
        'key_placeholder' => 'បញ្ចូលកូដតួនាទី',
        'label_en' => 'ឈ្មោះជាអង់គ្លេស',
        'label_en_placeholder' => 'បញ្ចូលឈ្មោះជាអង់គ្លេស',
        'name_kh' => 'ឈ្មោះជាខ្មែរ',
        'name_kh_placeholder' => 'បញ្ចូលឈ្មោះតួនាទីជាខ្មែរ',
        'help_user' => 'ប្រើសម្រាប់តួនាទីអ្នកប្រើប្រាស់ ឬ បេក្ខជន។',
        'help_staff' => 'ប្រើសម្រាប់តួនាទីបុគ្គលិកដូចជា អ្នកគ្រប់គ្រង បេឡាករ ហិរញ្ញវត្ថុ ការិយាល័យចុះបញ្ជី និងតួនាទីប្រព័ន្ធផ្សេងៗ។',
        'key_help_user' => 'ឧទាហរណ៍៖ candidate, master, associate។',
        'key_help_staff' => 'ឧទាហរណ៍៖ admin, cashier, finance, registrar។',
        'label_en_help_user' => 'ឧទាហរណ៍៖ Candidate, Master, Associate។',
        'label_en_help_staff' => 'ឧទាហរណ៍៖ Admin, Cashier, Finance, Registrar។',
        'name_kh_help_user' => 'ឧទាហរណ៍៖ បេក្ខជន, អនុបណ្ឌិត, បរិញ្ញាបត្ររង។',
        'name_kh_help_staff' => 'ឧទាហរណ៍៖ អ្នកគ្រប់គ្រង, បេឡាករ, ហិរញ្ញវត្ថុ, ការិយាល័យចុះបញ្ជី។',
        'options' => [
            'user' => 'អ្នកប្រើប្រាស់',
            'staff' => 'បុគ្គលិក',
        ],
