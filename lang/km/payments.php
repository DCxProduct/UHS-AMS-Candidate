...
return [
    ...
    'placeholders' => [
        ...
        'major' => 'សូមជ្រើសរើសផ្នែក',
        'type_payment' => 'សូមជ្រើសរើសប្រភេទទូទាត់',
        'exchange_rate' => 'សូមបញ្ចូលចំនួនប្រាក់រៀលសម្រាប់ 1 ដុល្លារ',
        'datetime_pay' => 'សូមជ្រើសរើសថ្ងៃបង់ប្រាក់',
        'receipt_number' => 'សូមបញ្ចូលលេខបង្កាន់ដៃ',
        'payment_slip' => 'សូមផ្ទុករូបភាពបង្កាន់ដៃបង់ប្រាក់',
        'amount_usd' => 'សូមបញ្ចូលចំនួនទឹកប្រាក់ដុល្លារអាមេរិច',
    ...
    'help' => [
        'exchange_rate' => 'កំណត់ពីម៉ឺនុយអត្រាប្តូរប្រាក់។',
    ],
    ...
    'validation' => [
        ...
        'payment_slip_required' => 'សូមផ្ទុកបង្កាន់ដៃបង់ប្រាក់។',
        'type_payment_required' => 'សូមជ្រើសរើសប្រភេទទូទាត់។',
        'exchange_rate_required' => 'សូមបញ្ចូលអត្រាប្តូរប្រាក់។',
        'exchange_rate_numeric' => 'អត្រាប្តូរប្រាក់ត្រូវតែជាលេខ។',
